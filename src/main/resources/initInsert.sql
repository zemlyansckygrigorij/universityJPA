...
Students must earn a minimum of 64  semester hours in order to receive a bachelor’s degree.'),
 (2,'Computer Science LEVEL second','Note: Individual program requirements may exceed the following minima.
...
-- for created name using sites https://blog.reedsy.com/character-name-generator/language/english/
--https://www.name-generator.org.uk/?i=730zmi8

insert into teacher(id, first_name ,second_name,last_name,gender,category,date_birth) values
(1,'Anthony','Hansen','Russell','MALE','Assistant Professor',' 08-07-97'),
(2,'Austin','Malcom','Young','MALE','Assistant Professor','04-01-91'),
(3,'Brandon','Tingey','Sullivan','MALE','Assistant Professor','04-06-92'),
(4,'Bron','Cantrell','Clark','MALE','Associate Professor','06-05-93'),
(5,'Calvin','Abbott','Reed','MALE','Associate Professor','04-04-94'),
(6,'Cooper','Payne','Thomas','MALE','Associate Professor','03-03-95'),
(7,'Dean','King','Brooks','MALE','Full Professor','06-02-96'),
(8,'Dominic','Bond','Murphy','MALE','Full Professor','07-01-97'),
(9,'Frank','Hansen','King','MALE','Full Professor','11-12-89'),
(10,'George','Castillo','Anderson','MALE','Full Professor','12-11-81'),
(11,'Alice','Ruell','Taylor','FEMALE','Assistant Professor','21-10-84'),
(12,'Angelina','Benson','Price','FEMALE','Assistant Professor','15-09-82'),
(13,'Beatrice','Cooke','Lee','FEMALE','Assistant Professor','23-08-83'),
(14,'Brianna','Wade','Green','FEMALE','Associate Professor','16-07-84'),
(15,'Caitlin','Marsh','Moore','FEMALE','Associate Professor','18-06-85'),
(16,'Carla','Hanson','Thompson','FEMALE','Associate Professor','19-05-86'),
(17,'Daisy','Manning','Wood','FEMALE','Associate Professor','01-04-87'),
(18,'Deborah','Kelley','Russell','FEMALE','Associate Professor','02-03-88'),
(19,'Elena','Perkins','Davis','FEMALE','Full Professor','03-02-89'),
(20,'Eliza','Walker','Adams','FEMALE','Full Professor','04-01-79'),
(21,'Hanah','Johnston','Williams','FEMALE','Full Professor','05-11-82'),
(22,'Helene','Dinwiddie','Phillips','FEMALE','Full Professor','05-12-90')
;
